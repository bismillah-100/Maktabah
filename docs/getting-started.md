...
* **OS / Target Deployment**: macOS 15+ (Sequoia) / iOS 18+
* **IDE**: Xcode 26+
...
2. **`Source/Features/`**: Modul berbasis *Domain-Driven Design* menggunakan pola arsitektur MVVM (Model-View-ViewModel). Meliputi modul Reader, Library, Annotations, Bookmarks, History, Search, Narrator, Quran, Setting, dan Widget.
