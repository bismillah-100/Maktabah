...
## QuranDataManager (Class)

Sebuah *singleton* beranotasi `@MainActor final class` yang mengelola koneksi basis data khusus (`special.sqlite`) dan mengoordinasikan pembacaan teks ayat Al-Qur'an serta kitab-kitab tafsir. Isolasi `@MainActor` menjamin seluruh manipulasi state pencarian, seleksi surah, dan navigasi ayat terikat aman pada antarmuka pengguna tanpa risiko *data race*.
