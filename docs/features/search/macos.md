...
### 1. `OptionSearchVC` (Search Controller)
...
### 2. `SearchSidebarVC` (Penyaring Cakupan / Scope)
...
### 3. `SearchCellView` (Render Cuplikan & Highlight)

* Subkelas `NSTableCellView` yang dirancang untuk me-*render* teks hasil dengan tipografi Arab RTL.
