...
```
- **`pauseController`**: Mengelola status jeda/lanjutkan saat pengguna beralih aktivitas atau membatasi penggunaan CPU.
...
Alur penerima hasil (*streaming pipeline*) dari *worker* FTS:
```swift
