...
## TarjamahGlobalManager (Class)

Pengelola data untuk menangani pencarian biografi lintas kitab.

- Mengandalkan isolasi via **Actor** (`TarjamahDatabaseActor`) untuk mencegah *race condition* saat kueri SQLite berlangsung.
