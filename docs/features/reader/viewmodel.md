...
*   **Task Cancellation**: `ReaderViewModel` menyimpan referensi tugas pemuatan dalam `currentLoadTask`. Jika pengguna berpindah halaman sebelum halaman saat ini selesai dimuat, tugas sebelumnya langsung dibatalkan (`currentLoadTask?.cancel()`).
