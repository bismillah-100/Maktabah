...
## 1. Pipeline Persistensi Snapshot
...
- **Thread-Safety & Multiprocess**: Menghindari kondisi pacu (*race condition*) saat aplikasi utama menulis snapshot baru persis ketika widget sedang me-refresh timeline.
