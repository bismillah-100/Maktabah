...
class AnnotationsVC: NSViewController {
    ...
    var floatPanel: Bool {
        UserDefaults.standard.bool(forKey: UserDefaults.TextViewKeys.annotationFloatWindow)
    }

    var hideOnPanel: Bool {
        UserDefaults.standard.bool(forKey: UserDefaults.TextViewKeys.annotationHideWindow)
    }
    ...
    @IBAction func floatPanel(_ sender: NSMenuItem) {
        ...
        UserDefaults.standard.set(
            on, forKey: UserDefaults.TextViewKeys.annotationFloatWindow
        )
    }
    ...
    @IBAction func hideOnPanel(_ sender: NSMenuItem) {
        ...
        UserDefaults.standard.set(
            on, forKey: UserDefaults.TextViewKeys.annotationHideWindow
        )
    }
