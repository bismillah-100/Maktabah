...
final class AnnotationCellView: NSTableCellView {
    ...
    private let timelineRail: NSBox = {
        let box = NSBox()
    ...
    private let timelineDot: TimelineNodeView = {
        let dot = TimelineNodeView()
    ...
    private func setupViews() {
        ...
        NSLayoutConstraint.activate([
            timelineRail.centerXAnchor.constraint(equalTo: trailingAnchor, constant: -4),
            timelineRail.widthAnchor.constraint(equalToConstant: TimelineMetrics.railLineWidth),
            timelineRail.topAnchor.constraint(equalTo: topAnchor),
            timelineRail.bottomAnchor.constraint(equalTo: bottomAnchor),

            timelineDot.centerXAnchor.constraint(equalTo: timelineRail.centerXAnchor),
            timelineDot.centerYAnchor.constraint(equalTo: topRowView.centerYAnchor),
            timelineDot.widthAnchor.constraint(equalToConstant: TimelineMetrics.dotSize),
            timelineDot.heightAnchor.constraint(equalToConstant: TimelineMetrics.dotSize),
    ...
    func setTimelineInset(_ isTimeline: Bool) {
        contentStackLeadingConstraint?.constant = 0
        contentStackTrailingConstraint?.constant = isTimeline ? -16 : -8
        rightBorder.isHidden = isTimeline
        bottomBorder.isHidden = isTimeline
        timelineRail.isHidden = !isTimeline
        timelineDot.isHidden = !isTimeline
    }
}
